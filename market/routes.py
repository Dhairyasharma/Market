...
#creating a new route to home page
@app.route('/')
@app.route('/home')
def home_page():
    return render_template('home.html')

#creating a route to Market
    ...
    if request.method == "POST":
        ...
        if p_item_object:
            if current_user.can_purchase(p_item_object):
                ...
                flash(f"Unfortunately, you don't have enough money to purchase {p_item_object.name}", category="warning")
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Something Went Wrong {s_item_object.name}", category="warning")
